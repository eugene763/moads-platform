...
| M6 | Set `Lab` pricing CTA links (`https://lab.moads.agency`) to point to Creem checkout product mapping once Starter checkout is live | `apps/aeo-web/app/page.tsx` |
