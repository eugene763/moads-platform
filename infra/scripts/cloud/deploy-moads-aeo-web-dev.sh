...
if [[ -z "${NEXT_PUBLIC_FIREBASE_API_KEY:-}" || -z "$AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN" || -z "${NEXT_PUBLIC_FIREBASE_APP_ID:-}" ]]; then
  echo "NEXT_PUBLIC_FIREBASE_API_KEY, AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN (or NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN), and NEXT_PUBLIC_FIREBASE_APP_ID are required." >&2
  exit 1
fi
...
env_pairs=(
  ...
  "NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=$AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN"
