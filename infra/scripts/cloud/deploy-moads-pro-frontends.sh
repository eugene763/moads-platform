...
AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN="${AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN:-$NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN}"
LAB_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN="${LAB_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN:-$NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN}"
...
if [[ -z "$NEXT_PUBLIC_FIREBASE_API_KEY" || -z "$AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN" || -z "$LAB_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN" || -z "$NEXT_PUBLIC_FIREBASE_APP_ID" ]]; then
  echo "NEXT_PUBLIC_FIREBASE_API_KEY, AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN/LAB_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN (or NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN), and NEXT_PUBLIC_FIREBASE_APP_ID are required." >&2
  exit 1
fi
...
AEO_ENV_STRING="$(build_frontend_env "$AEO_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN")"
LAB_ENV_STRING="$(build_frontend_env "$LAB_NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN")"

deploy_frontend_service "$AEO_SERVICE_NAME" "$ROOT_DIR/apps/aeo-web" "$AEO_ENV_STRING"
deploy_frontend_service "$LAB_SERVICE_NAME" "$ROOT_DIR/apps/lab-web" "$LAB_ENV_STRING"
