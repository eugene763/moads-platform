...
DEV_ALLOWED_ORIGINS="${DEV_ALLOWED_ORIGINS:-http://127.0.0.1:3000,http://localhost:3000,https://trend.moads.agency,https://lab-dev.moads.agency,https://aeo-dev.moads.agency,https://ugc-dev.moads.agency}"
